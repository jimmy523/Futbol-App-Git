 ...
 */
public class BuildFixtureLiga extends StrategyBuildFixture{


    public BuildFixtureLiga(Calendar fechaInicio, Collection<Equipo> equipos, Collection<Cancha> canchas, Collection<Arbitro> arbitros, int duracionEncuentros, String franjaHoraria, Integer[] diasTorneo) {
